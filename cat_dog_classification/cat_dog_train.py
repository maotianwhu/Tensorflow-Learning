...
data = cat_dog_dataset.read_train_sets(train_path, img_size, classes, validation_size = validation_size)
...
keep_prob = tf.placeholder(tf.float32, name='keep_prob')   #至关重要
...
def show_progress(epoch, feed_dict_train, feed_dict_val, val_loss, i):
...
def train(num_iteration):
    ...
    for i in range(total_iterations, total_iterations + num_iteration):
        ...
        feed_dict_tr = {x: x_batch, y_true: y_true_batch, keep_prob:1}
